/*
  ...
  1. Tables
    - offer_review_requests: Stores review request details
    - offer_reviews: Stores individual reviews
    - offer_review_documents: Stores review-related documents
    - offer_review_history: Tracks review status changes

  2. Storage
    - Creates drp-documents bucket
