/*
  # Review System Cleanup and Recreation
  
  Drops and recreates the review system tables and views in the correct order
  to handle dependencies.
*/

-- Drop views first to handle dependencies
